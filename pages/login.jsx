  ...
  return (
    <div>
      ...
      <div className="flex h-screen justify-center items-center relative bg-login-background bg-no-repeat bg-cover opacity-85">
        <div className="absolute w-full top-20 px-20 flex items-center text-white">
          <h2 className="text-4xl font-bold mr-5">OYO</h2>
          <p className=" font-bold text-2xl">
            Hotels and homes across 800 cities, 24+ countries
          </p>
        </div>
        <div className="flex justify-center items-center w-9/12 mt-32">
          <div className="text-white">
            <p className="font-bold text-5xl tracking-wide">
          ...
          <div className="ml-20 pb-40 w-10/12 border bg-slate-50">
            <p className="h-10 flex items-center px-10 bg-gradient-to-r from-red-600 to bg-red-400 text-lg font-bold text-white">
            ...
            <div className="px-10">
              ...
              <button
                type="submit"
                className="w-96 h-14 text-lg from-bold bg-red-500 hover:cursor-pointer hover:bg-red-600 text-white my-5 rounded-lg"
